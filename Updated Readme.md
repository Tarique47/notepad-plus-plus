...
## To build `notepad++.exe`:
 ...
 3. Scilexer.dll dosent have necessary authorizations to be built for most people. In that case an easy way to skip the steps below and build the project successfully is to 
    download a copy of notepad plus plus and copy the SciLxer.dll file and then paste it into the location where the clone repo is located.
    In my case the root folder where I copied the dll file is here -> C:\Users\Desktop\notepad-plus-plus-master\PowerEditor\visual.net\x64\Unicode Debug
...
Here are the instructions to build SciLexer.dll (for both 32-bit & 64-bit) for Notepad++:
 ...
 4. After building SciLexer.dll put the dll file in this directory to build the project successfully or else the project crashes and gives a linking error. 
    In my case the root folder where I copied the dll file is here -> C:\Users\Desktop\notepad-plus-plus-master\PowerEditor\visual.net\x64\Unicode Debug
